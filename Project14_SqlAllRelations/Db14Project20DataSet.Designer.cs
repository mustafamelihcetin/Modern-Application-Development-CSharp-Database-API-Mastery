...
namespace Project14_SqlAllRelations {
    ...
    public partial class Db14Project20DataSet : global::System.Data.DataSet {
        ...
        public partial class TeamsDataTable : global::System.Data.TypedTableBase<TeamsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TeamsRow AddTeamsRow(string TeamName, string TeamCountry) {
            ...
            private void InitClass() {
                ...
                this.columnTeamCountry.MaxLength = 100;
            }
        ...
        public partial class TeamsRow : global::System.Data.DataRow {
            ...
            public string TeamCountry {
                get {
                    try {
                        return ((string)(this[this.tableTeams.TeamCountryColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'TeamCountry\' in table \'Teams\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableTeams.TeamCountryColumn] = value;
                }
            }
            ...
            public bool IsTeamCountryNull() {
                return this.IsNull(this.tableTeams.TeamCountryColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetTeamCountryNull() {
                this[this.tableTeams.TeamCountryColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Project14_SqlAllRelations.Db14Project20DataSetTableAdapters {
    ...
    public partial class TeamsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Teams] WHERE (([TeamID] = @Original_TeamID) AND ((@IsNull_Team" +
                "Name = 1 AND [TeamName] IS NULL) OR ([TeamName] = @Original_TeamName)) AND ((@Is" +
                "Null_TeamCountry = 1 AND [TeamCountry] IS NULL) OR ([TeamCountry] = @Original_Te" +
                "amCountry)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Teams] ([TeamName], [TeamCountry]) VALUES (@TeamName, @TeamCou" +
                "ntry);\r\nSELECT TeamID, TeamName, TeamCountry FROM Teams WHERE (TeamID = SCOPE_ID" +
                "ENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Teams] SET [TeamName] = @TeamName, [TeamCountry] = @TeamCountry WHERE (([TeamID] = @Original_TeamID) AND ((@IsNull_TeamName = 1 AND [TeamName] IS NULL) OR ([TeamName] = @Original_TeamName)) AND ((@IsNull_TeamCountry = 1 AND [TeamCountry] IS NULL) OR ([TeamCountry] = @Original_TeamCountry)));
SELECT TeamID, TeamName, TeamCountry FROM Teams WHERE (TeamID = @TeamID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Project14_SqlAllRelations.Properties.Settings.Default.Db14Project20ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT TeamID, TeamName, TeamCountry FROM dbo.Teams";
        ...
        public virtual int Fill(Db14Project20DataSet.TeamsDataTable dataTable) {
        ...
        public virtual Db14Project20DataSet.TeamsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Db14Project20DataSet.TeamsDataTable dataTable = new Db14Project20DataSet.TeamsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Db14Project20DataSet.TeamsDataTable dataTable) {
